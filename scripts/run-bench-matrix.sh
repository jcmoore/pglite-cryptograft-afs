...
export CRYPTOGRAFT_MATRIX_CHUNK_SIZES="${CRYPTOGRAFT_MATRIX_CHUNK_SIZES:-4096,8192,16384}"
GRAFT_MATRIX_PAGESIZES_KB="${GRAFT_MATRIX_PAGESIZES_KB:-4,8,16}"
...
EOF
    ...
    echo
    echo "=== bench:matrix page size ${kb}KiB impl ${impl} ==="
